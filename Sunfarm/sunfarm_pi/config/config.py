"""
SunFarm Smart Irrigation - Raspberry Pi Deployment Configuration
================================================================
Centralized configuration parameters for sensor boundaries, motor control
hysteresis thresholds, ML model paths, and class definitions for Raspberry Pi.
"""

from pathlib import Path

# Base Paths on Raspberry Pi
