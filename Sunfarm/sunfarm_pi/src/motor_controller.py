"""
SunFarm Smart Irrigation - Raspberry Pi Motor Controller (Safety Layer)
=======================================================================
Deterministic rule-based motor controller with configurable hysteresis
designed for edge execution on Raspberry Pi.
...
- Invalid/Out-of-range sensor readings: Turn Motor OFF (Fail-safe shutdown)
"""
...
def evaluate_motor(
    ...
    """
    Convenience function to evaluate motor state on Raspberry Pi.
    """
